...
public class MemberView {
	...
	public void mainMenu() {
		...
		while (true) { // 조건식이 true인 동안 계속 반복
			...
			switch (menu) {
			case 1 : insertMember(); // 비교적 쉬움
					break;
			case 2 : selectAll(); // 비교적 쉬움
					break;
			case 3 : selectByUserId();
					break;
			case 4 : selectByUserName(); // 비교적 어려움
					break;
			case 5 : updateMember(); // 비교적 어려움
					break;
			case 6 : deleteMember(); // 비교적 쉬움; 쉬운 것부터 만드는 것도 전략..
					break;
